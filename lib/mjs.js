...
function parseArgs(argv) {
  ...
  var minimistOpts = {
    ...
    boolean: ['debug', 'help', 'map', 'map-embed', 'map-source', 'color', 
              'es5', 'es5-generators', 'es5-destructuring',
  ...
  // Enable all es5 compatibility flgas
  if (opts['es5']) {
    config.es5Destructuring = true;
    config.es5Generators = true;
  }

  // Apply defaults
  defs['es5-generators'] = config.es5Generators;
  defs['es5-destructuring'] = config.es5Destructuring;
  ...
  config.es5Destructuring = opts['es5-destructuring'];
...
function showHelpAndExit(error, exitcode) {
  ...
  stdout([
    ...
    '               -5, --es5  Enable all ES5 emulations [default: off]',
    '        --es5-generators  Emulate generators for ES5 [default: off]',
    '     --es5-destructuring  Emulate destructuring for ES5 [default: off]',
